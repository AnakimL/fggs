      ...
      var l = function l(a, b) {
        ...
        return e(d, [{
          ...
          value: function value() {
            ...
            for (var a = 0; a < this.p.length; a++) {
              var b = this.p[a];
              if (this._c(b.iso2, b.dialCode, b.priority), b.areaCodes) for (var c = 0; c < b.areaCodes.length; c++) {
          ...
          key: "_o2",
          value: function value(a) {
            for (var b = a; b && b !== this.m && !b.classList.contains("country");) {
              b = b.parentNode;
            }
          ...
          value: function value(a) {
            ...
            if (d) {
              ...
              if (!("1" === this.s.dialCode && this._w(e)) && (!h || i)) for (var j = 0; j < g.length; j++) {
                if (g[j]) {
                  f = g[j];
                  break;
                }
