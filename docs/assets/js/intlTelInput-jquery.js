...
(function (factory) {
  ...
  "use strict"; // Array of country objects for the flag dropdown.
  ...
  ********************/
  ...
  $.fn[pluginName] = function (options) {
    ...
    if (options === undefined || _typeof(options) === "object") {
      ...
      var returns;
      this.each(function () {
        var instance = $.data(this, "plugin_" + pluginName); // Tests that there's already a plugin-instance and checks that the requested public method exists
